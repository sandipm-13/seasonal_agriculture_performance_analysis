...
Upload SAPA(2).ipynb
Upload seasonal_agriculture_performance_dataset.csv to the Colab files panel
...
Strengthen pest-control in Kharif — 54.5% disease risk needs targeted intervention
Support Zaid farmers — policy-level subsidies needed as 64.5% run at a loss
🔭 Future Scope
